...
{ 
  ...
  Transform2.multiply(Transform1);
  Transform2.multiply(boneMatrices[1]);
  Transform2.multiply(new THREE.Matrix4().makeRotationX(angle));
  Transform2.multiply(new THREE.Matrix4().makeRotationZ(-angle));
